...
def eval_tests() -> dict:
    ...
    try:
        ...
        if passed:
            ...
            score = 0.0 if not error_lines else max(0.0, 1.0 - len(error_lines) * 0.05)
        return {
            "name": 'tests',
            "score": score,
...
def eval_observability() -> dict:
    ...
    if total_fn == 0:
        return {"name": "observability", "score": 0.0, "weight": 0.09523809523809523,
    ...
    return {"name": "observability", "score": round(score, 3), "weight": 0.09523809523809523,
            "passed": score >= 0.3, "details": details}

# Register all eval functions here.
EVALS = [eval_tests, eval_lint, eval_type_check, eval_observability]
